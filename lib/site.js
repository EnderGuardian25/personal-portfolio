...
// Desktop + mobile navigation. Hrefs starting with "#" are in-page anchors on
// the homepage; Nav rewrites them to "/#id" when viewed from another route.
// Hrefs starting with "/" are standalone routes (e.g. the Services page).
