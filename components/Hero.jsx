    ...
    <section id="top" ref={ref} className="relative min-h-screen w-full overflow-hidden pt-44 md:pt-52">
      ...
      <div className="absolute top-28 right-6 md:right-10 flex flex-col items-end gap-4 z-10">
        ...
        <motion.a
          ...
          className="hidden md:inline-flex items-center gap-2 bg-electric px-5 py-2.5 font-mono text-[11px] uppercase tracking-[0.2em] text-ivory hover:bg-electric/90 transition-colors duration-300 group"
        >
          Services
