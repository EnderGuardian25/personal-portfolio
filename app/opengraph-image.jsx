  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Name */}
        <div style={{ display: "flex", flexDirection: "column", lineHeight: 0.83 }}>
          <div style={{ fontSize: 178, fontWeight: 700, color: "#0B1F3A", textTransform: "uppercase", letterSpacing: "-0.055em", lineHeight: 0.88 }}>
            DAMIAN
          </div>
          <div style={{ display: "flex", fontSize: 178, fontWeight: 700, textTransform: "uppercase", letterSpacing: "-0.055em", lineHeight: 0.88 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          ...
          <div style={{ fontFamily: "monospace", fontSize: 12, letterSpacing: "0.18em", color: "#16315A", textTransform: "uppercase", opacity: 0.6 }}>
